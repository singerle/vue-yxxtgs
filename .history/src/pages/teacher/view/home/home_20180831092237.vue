    ...
    <div class="home-content" v-if="stu">
      <ul class="items">
        ...
        <li class="item" v-if="options.channel.flag">
          <div class="item-wraper border-right"  @click="toPage('channel', options.register.eaaRevoke)">
            <div class="icon channel"></div>
            <div class="text">绿色通道</div>
          </div>
        </li>
        <li class="item" v-if="options.sushe.flag">
          <div class="item-wraper border-left"  @click="toPage('sushe', options.register.eaaRevoke)">
            <div class="icon sushe"></div>
            <div class="text">宿舍分配</div>
          </div>
        </li>
        <li class="item" v-if="options.insurance.flag">
          <div class="item-wraper border-right" @click="toPage('insurance', options.register.eaaRevoke)">
            <div class="icon insurance"></div>
            <div class="text">保险购买</div>
          </div>
        </li>
        <li class="item" v-if="options.caiwu.flag">
          <div class="item-wraper border-left" @click="toPage('caiwu', options.register.eaaRevoke)">
            <div class="icon caiwu"></div>
            <div class="text">财务缴费</div>
          </div>
        </li>
        <li class="item" v-if="options.manage.flag">
          <div class="item-wraper border-right"  @click="toPage('manage', options.register.eaaRevoke)">
