...
<div class="bgcolor">
  	<div class="notice-detail">
	  	<h3>{{notice_xq.tzbt}}</h3>
	  	<p class="shijian">
	  		<span>
	  			<span class="date">{{notice_xq.fbsj}}</span>
	  		</span>
	  		<span class="viewer">{{notice_xq.llcs}}</span>
	  	</p>
	  	<!-- <div class="pic" :style="{background: `url(${notice_xq.fmtp})`,'background-size': 'contain'}"></div> -->
	  	<!-- <div class="pic" v-handleImg="notice_xq.fmtp"></div> -->
	  	<p class="detail" v-html="notice_xq.tznr"></p>
	</div>
  </div>
</template>
