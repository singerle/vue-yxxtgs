  ...
  <div class="addednews-wrapper">
    <div class="header-wrap">
      ...
      <el-breadcrumb class="crumbs" separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: backnewspage }">新闻公告</el-breadcrumb-item>
        <el-breadcrumb-item v-if='!this.newsid'>新增</el-breadcrumb-item>
        <el-breadcrumb-item v-if='this.newsid'>修改</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="control-wrap">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" enctype="multipart/form-data">
        ...
        <el-form-item>
          ...
          <el-button v-show='!this.newsid' type="primary" @click="submitForm('ruleForm')">提交</el-button>
          <el-button v-show='this.newsid' type="primary" @click="modify('ruleForm')">修改</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        backnewspage: '/newsPublicity/news',
        imageList: [
    ...
    methods: {
      ...
      _modifylist(){
        if(this.newsid === ''){
          ...
          modifylist(this.newsid).then(res => {
            res = res.data
