<template>
    <div class="newsCentral-wrapper">
      <el-table class="newstable" :data="tableData"  style="width: 100%">
        ...
        <el-table-column prop="time" :formatter="fmtDate" label="创建时间" > </el-table-column>
        <el-table-column prop="Readnumber" label="阅读量" :render-header="rendernum"> </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      modifynews(row) {
        ...
        this.$router.push({path: this.modifypage})
      },
      ...mapMutations({
        '_setId': 'SET_NEWS_ID' 
      }),
