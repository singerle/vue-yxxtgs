<template>
  <div class="synthesis-wrapper">
    <header class="header">
      <div>
        <span class="title header-item h-left">王大军</span>
    ...
    <div class="syn-content">
      <businfon-wrapper :infos="infos" :radio="radio" :titles="titles"></businfon-wrapper>
    </div>
...
export default {
  ...
  methods: {
    _fetchInfo() {
      ...
      // this.busInfo为用户信息
      fetchInfo(this.busInfo.userId, this.radio).then(res => {
        loading.close()
        res = res.data
