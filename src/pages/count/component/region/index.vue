        ...
        <div>
          <table>
            ...
            <tr v-for="item in dqfb">
              ...
              <td>{{((item.sd*1000000)/(item.zrs*10000))!=0 ? ((item.sd*1000000)/(item.zrs*10000)).toFixed(2):0}}%</td>
            </tr>
          </table>
        </div>
      </div>
    </div>
    <div v-else-if="activeIndex == 0"
         class="regionContent">
        ...
        <div>
          <table>
            ...
            <tr v-for="item in progress">
              ...
              <td>{{((item.sd*1000000)/(item.zrs*10000))!=0 ? ((item.sd*1000000)/(item.zrs*10000)).toFixed(2):0}}%<span class="iconfont icon-gengduo"
                      @click="togo(item.xybh)"></span></td>
            </tr>
          </table>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      types: [{ name: '按学院', type: 1, active: true }, { name: '按地区', type: 2, active: false }],
      snswType: ''
    }
  },
  activated () {
